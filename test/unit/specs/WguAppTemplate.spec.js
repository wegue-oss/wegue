...
describe('WguAppTpl.vue', () => {
  ...
  describe('data', () => {
    ...
    it('has correct default data', () => {
      ...
      expect(vm.moduleWins).to.be.an('array');
  ...
  describe('methods', () => {
    ...
    it('getModuleWinData returns always an array', () => {
      // mock a window UI instance
      const moduleData = vm.getModuleWinData();
      expect(moduleData).to.be.an('array');
    });

    it('getModuleWinData returns correct data', () => {
      // mock a module conf
